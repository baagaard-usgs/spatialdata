...
The simplest spatial database implementation is a field with uniform values.
...
The `CompositeDB` type is used to combine values from multiple spatial databases into a single spatial database.
