...
// Helper class for SpatialDB Python API.
class spatialdata::spatialdb::PySpatialDB {
public:

    static
    std::tuple < py::array_t<double>, py::array_t<int> >query(spatialdata::spatialdb::SpatialDB& db,
